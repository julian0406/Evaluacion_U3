...
public class MySQLConnection {
    final String DBNAME = "recupera2",
            USER = "root",
            PASSWORD = "chimuelo2004",
    ...
    public Connection connect() {
        String dataSource = String.format(
                "jdbc:mysql://%s:3307/%s?user=%s&password=%s&serverTimezone=%s&useSSL=%s&allowPublicKeyRetrieval=%s&createDatabaseIfNotExist=%s",
